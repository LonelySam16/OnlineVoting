    ...
    <body>
            ...
            <div id="mainSection">
                <div id="profileSection">
                    <center><img src="../uploads/<?php echo $data['photo']?>" height="100" width=auto></center><br>
                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                ...
                                <img style="float: right" src="../uploads/<?php echo $groups[$i]['photo']?>" height="80" width=auto>
                                ...
                                if($_SESSION['status']==1){
                                    ...
                                    ?>
                                    <button style="padding: 5px; font-size: 15px; background-color: #413F3D; color: white; border-radius: 5px;" type="submit">Vote</button>
                                    <?php
                                }
                                ?>
                                </form>
